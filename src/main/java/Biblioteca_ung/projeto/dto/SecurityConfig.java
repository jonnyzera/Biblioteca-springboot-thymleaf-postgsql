        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                .authorizeHttpRequests(authorize -> authorize
                                                .requestMatchers("/biblioteca/perfil/form", "/biblioteca/perfil/salvar",
                                                                "/css/**", "/js/**", "/images/**",
                                                                "/biblioteca/cadastro/login", "/")
                                                .permitAll()
                                                .requestMatchers("/biblioteca/livro/**", "/biblioteca/usuario/**")
                                                .hasRole("BIBLIOTECARIO")
                                                .requestMatchers("/biblioteca/emprestimo/**")
                                                .hasAnyRole("USUARIO", "BIBLIOTECARIO")
